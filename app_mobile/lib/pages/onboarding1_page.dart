  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: SafeArea(child: PageView(
        ...
        children: [
          PageOneWidget(availHeight: availHeight, pageController: pageController),
          PageTwoWidget(availHeight: availHeight, pageController: pageController),
          PageThreeWidget(availHeight: availHeight, pageController: pageController),
        ],
    ...
    child: Column(
      ...
      Center(
        child: FadeInDown(
          ...
          child: Text("Easy step to use!", style: TextStyle(fontWeight: bold, fontSize: MediaQuery.of(context).size.width * 0.1), 
  ...
  Widget build(BuildContext context) {
    ...
    child: Column(
      ...
      Center(
        child: FadeInDown(
          delay: Duration(milliseconds:500),
          child: Text("Empowering Equality", style: TextStyle(fontWeight: bold, fontSize: MediaQuery.of(context).size.width * 0.1), 
          textAlign: TextAlign.center,)
        ),
      ),
      Center(
    ...
    child: Column(
      ...
      Center(
        child: FadeOut(
          ...
          child: Lottie.asset(
            'animations/visualizeInclusivity.json',
            height: 350,
            reverse: true,
            repeat: true,
            fit: BoxFit.cover
      ...
      Center(
        child: FadeInDown(
          delay: Duration(milliseconds:500),
          child: Text("Visualize Inclusivity", style: TextStyle(fontWeight: bold, fontSize: MediaQuery.of(context).size.width * 0.1), 
          textAlign: TextAlign.center,)
        ),
      ),
      Center(
